...
// @version     20251211-160411-971027d
...
const getUrlSearchParams = () => {
    return Object.fromEntries(document.location.search.slice(1).split('&').map(item=>[item.slice(0,item.indexOf('=')), item.slice(item.indexOf('=')+1)]).filter(entry=>entry[0].length));
}

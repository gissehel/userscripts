...
registerDomNodeMutatedUnique(
    () => document.querySelectorAll('.modal-box.max-h-11\\/12 .border-base-content\\/20.rounded-field.mt-3.flex.w-full.items-center.gap-1.border-2.py-1\\.5.pl-4.pr-2\\.5 button.btn.btn-primary'),
    async (copyButton) => {
